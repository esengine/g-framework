...
(function (gs) {
    var EventPool = /** @class */ (function (_super) {
        ...
        function EventPool() {
            return _super.call(this, function () { return new gs.GEvent("", null); }, function (event) { return event.reset(); }) || this;
        }
        return EventPool;
    }(gs.ObjectPool));
...
(function (gs) {
    var GEvent = /** @class */ (function () {
        ...
        GEvent.prototype.reset = function () {
            this.type = "";
            this.data = null;
        };
        GEvent.prototype.getType = function () {
            return this.type;
        };
        GEvent.prototype.getData = function () {
            return this.data;
        };
        return GEvent;
    }());
...
(function (gs) {
    var Authentication = /** @class */ (function () {
        ...
        Authentication.prototype.startAuthentication = function (username, password) {
            var payload = {
                username: username,
                passwordHash: gs.WebSocketUtils.hashPassword(password),
            };
